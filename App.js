...
import { Animated, Image, FlatList, Text, View, StatusBar, Dimensions, StyleSheet } from 'react-native';
    ...
    return <View style={{flex: 1}}>
        ...
        <View style={{height: ITEM_HEIGHT, overflow: 'hidden'}}>
            ...
            renderItem={({item, index}) => {
              return <View>
                <Image source={{uri: item}} alt={item.index} style={styles.image}></Image>
              </View>
            }}
            />
        ...
        <BottomSheet
            ...
            >
              <BottomSheetScrollView style={{backgroundColor: 'white'}} contentContainerStyle={{padding: 20}}>
                <Text style={{fontWeight: '800', fontSize: 16, textTransform:'uppercase'}}>{product.title}</Text>
